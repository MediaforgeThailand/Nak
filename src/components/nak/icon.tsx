...
// Ported 1:1 from the redesign prototype (app/icons.jsx). Minimal
// lucide-style stroke icons so every NAK screen shares one icon API.
const NAK_ICON_PATHS: Record<string, ReactNode> = {
  search: (
    <>
  ...
  cart: (
    <>
      ...
      <path d="M2.5 3h2l2.5 12.4a2 2 0 0 0 2 1.6h9.3a2 2 0 0 0 2-1.57l1.5-7.43H5.4" />
    </>
  ),
  wallet: (
    <>
  ...
  phone: (
    <path d="M13.8 10.2a8 8 0 0 0 3.6 3.6l1.2-1.2a1 1 0 0 1 1-.25 11 11 0 0 0 3.4.55 1 1 0 0 1 1 1V18a1 1 0 0 1-1 1A16 16 0 0 1 3 5a1 1 0 0 1 1-1h3.4a1 1 0 0 1 1 1 11 11 0 0 0 .55 3.4 1 1 0 0 1-.25 1z" />
  ),
  shield: (
    <>
